 ...
 *
 * Contributors: IBM Corporation - initial API and implementation Lars Vogel <Lars.Vogel@gmail.com>
 * - Bug 414565 Robert Roth <robert.roth.off@gmail.com> - Bug 417685
 *******************************************************************************/
...
public class Snippet006TableMultiLineCells {
  ...
  class LineEntry {
    ...
    /**
     * Create a new instance of the receiver with name text constrained to a column of width.
     */
  ...
  public Snippet006TableMultiLineCells() {
    String[] lines =
        new String[] {"This day is called the feast of Crispian:",
            ...
            "But we in it shall be remember'd;", "We few,\n we happy few,\n we band of brothers;",
  ...
  public void createPartControl(Composite parent) {
    ...
    viewer.setSelection(new StructuredSelection(entries[2]));
  }
  ...
  private void createColumns() {
    ...
    layout.addColumnData(new ColumnPixelData(370));
    tc.setText("Lines");
