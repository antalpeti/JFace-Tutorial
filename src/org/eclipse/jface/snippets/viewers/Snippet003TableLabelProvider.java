/*******************************************************************************
 * Copyright (c) 2006 - 2014 Tom Schindl and others. All rights reserved. This program and the
 * accompanying materials are made available under the terms of the Eclipse Public License v1.0
 * which accompanies this distribution, and is available at
 * http://www.eclipse.org/legal/epl-v10.html
 *
 * Contributors: Tom Schindl - initial API and implementation Lars Vogel <Lars.Vogel@gmail.com> -
 * Bug 414565
 *******************************************************************************/
...
public class Snippet003TableLabelProvider {
  ...
  public class MyLabelProvider extends LabelProvider implements ITableLabelProvider {
    ...
    public Image getColumnImage(Object element, int columnIndex) {
      if (columnIndex == 1) {
        return images[((MyModel) element).counter % 6];
      }
  ...
  public static void main(String[] args) {
    ...
    images[4] = createImage(display, 255, 255, 0);
    images[5] = createImage(display, 0, 0, 0);
